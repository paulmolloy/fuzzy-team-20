...
fis = addMF(fis,"gear","trapmf",[0 0 1 1.5],'Name',"first");
...
fis = addMF(fis,"gear","trapmf",[4.5 5  6 6],'Name',"fifth");
...
% TODO: Add more rules.
rulesList = [1 1 0 0 1 1 1;  % if very_slow && normal temp-≥ first
             2 1 0 0 2 1 1;  % if very_slow && high temp -> second
...
plotmf(fis,"output",1)
        ...
        % Temp  Speed  Throttle   friction 
inputs = [
          1 1 0 0;
          40 1 0 0;
          40 1 4.5 .78; % normal temp, very slow, throttle open, rough
          120 15 4.5 .78; % high temp, very slow, throttle open, rough
